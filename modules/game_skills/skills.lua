...
local function refreshGroupData(groupName)
    ...
    scheduleEvent(function()
        if groupName == 'offence' then
            ...
            onAttackInfoChange(player, statsCache.attackValue, statsCache.attackElement, statsCache.attackBreakdown)
        ...
        elseif groupName == 'defence' then
            ...
            onDefenseInfoChange(player, statsCache.defense, statsCache.armor, statsCache.mantra, statsCache.mitigation, statsCache.dodge, statsCache.damageReflection, statsCache.defenseBreakdown)
...
function onAttackInfoChange(localPlayer, attackValue, attackElement, attackBreakdown)
    -- Cache the data regardless of visibility
    statsCache.attackValue = attackValue or 0
	statsCache.attackElement = attackElement or 0
	statsCache.attackBreakdown = attackBreakdown or ''
	setSkillValue('attackTotal', comma_value(statsCache.attackValue))
	setSkillTooltip('attackTotal', statsCache.attackBreakdown)
...
function onDefenseInfoChange(localPlayer, defense, armor, mantra, mitigation, dodge, damageReflection, defenseBreakdown)
    -- Cache the data regardless of visibility
	...
	statsCache.defenseBreakdown = defenseBreakdown or ''
	setSkillValue('defenseTotal', comma_value(statsCache.defense))
	setSkillTooltip('defenseTotal', statsCache.defenseBreakdown)
