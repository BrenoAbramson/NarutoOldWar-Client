...
function EnterGame.init()
    ...
    local clientVersion = DEFAULT_CLIENT_VERSION

    g_settings.set('host', DEFAULT_SERVER_HOST)
    g_settings.set('port', DEFAULT_SERVER_PORT)
    g_settings.set('client-version', DEFAULT_CLIENT_VERSION)
