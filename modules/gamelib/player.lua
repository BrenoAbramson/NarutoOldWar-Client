...
ConditionIcons = {
    ...
    [4] = {
        state = PlayerStates.Kawarimi,
        clip = 16,
        name = "kawarimi",
        path = '/images/game/states/kawarimi.png',
		customImage = '/images/game/states/kawarimi.png',
        id = 'condition_Kawarimi',
        visibleHud = true,
        visibleBar = true,
        tooltipBar = tr('Kawarimi ativo'),
        tooltip = tr('O próximo ataque será evitado pelo Kawarimi.')
    },
    [5] = {
