...
function replaceBottomBarWithJutsus(jutsus)
    ...
    for slot, jutsu in ipairs(jutsus or {}) do
        if slot > 50 then
            break
        end
    ...
    ApiJson.setBarVisibility(2, 'actionBarShowBottom2', false, true)
...
rebuildActiveActionBars = function()
