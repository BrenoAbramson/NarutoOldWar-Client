...
if ENABLE_SERVERS then
    ...
    Servers_init = {
        ...
        ["http://127.0.0.1/login.php"] = {
            ...
            -- Keep false while this address uses the legacy server executable.
            -- Enable only together with a server rebuilt for uint16 visual IDs.
            visualIdsU16 = true
        },
...
g_app.setName("Naruto Old War");
g_app.setCompactName("otclient");
g_app.setOrganizationName("Naruto Old War");

-- Keep settings and logs in the operating system's writable user directory.
-- On Windows this avoids Program Files permission errors and guarantees that
-- otclient.log is available for diagnostics.
...
-- setup logger
g_logger.setLogFile(g_resources.getWriteDir() .. g_app.getCompactName() .. '.log')
